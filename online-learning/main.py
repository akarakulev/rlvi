...
def update_weights_rlvi(residuals, tol=1e-3, maxiter=100):
    ...
    # to account for shifting the residuals in the beginning
...
def plot_score_evolution(clf_stats, smooth_deg=1):
    ...
    plt.xlabel(r'observed samples $\times 10^3$', font_properties=roboto_font)
    plt.ylabel(r'Accuracy, %', font_properties=roboto_font)
    plt.xlim(1, 10.8)
...
def plot_tp_evolution(clf_stats, smooth_deg=1):
    ...
    plt.xlabel(r'observed samples $\times 10^3$', font_properties=roboto_font)
    plt.ylabel('Recall', font_properties=roboto_font)
    plt.xticks(fontsize=20)
...
def plot_tn_evolution(clf_stats, smooth_deg=1):
    ...
    plt.xlabel(r'observed samples $\times 10^3$', font_properties=roboto_font)
    plt.ylabel('TN rate', font_properties=roboto_font)
    plt.xlim(1, 10.8)
    plt.xticks(fontsize=20)
...
def plot_f1_evolution(clf_stats, smooth_deg=1):
    ...
    plt.xlabel(r'observed samples $\times 10^3$', font_properties=roboto_font)
    plt.ylabel(r'$F_1{-}$score', font_properties=roboto_font)
    plt.xlim(1, 10.8)
    plt.xticks(fontsize=20)
    plt.yticks(np.arange(0.8, 1.01, 0.05), fontsize=20)
    plt.ylim(0.8, 1)
